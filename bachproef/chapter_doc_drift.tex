...
\textcite{theunissen2022mappingdocumentation} bevestigen dat geautomatiseerde detectie en CI/CD-validatie behoren tot de meest effectieve strategieën om drift te beperken in continuous software development.
...
Dit hoofdstuk sluit aan bij het vorige hoofdstuk over code as documentation: samen vormen ze een raamwerk voor het schrijven en onderhouden van documentatie die accuraat, bruikbaar en duurzaam is. Waar code as documentation zich richt op het \textit{voorkomen} van drift door goede praktijken, behandelt dit hoofdstuk het fenomeen zelf en de strategieën om het te detecteren, te beperken en uiteindelijk te elimineren.

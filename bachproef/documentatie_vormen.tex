...
Op basis van deze vergelijking is Jupyter-notebooks geselecteerd als het primaire platform voor de Proof of Concept. De combinatie van gebruiksvriendelijkheid, de krachtige Python.NET bridge en de containerisatie weegt zwaarder dan de nadelen van de andere formaten. Hiermee is de keuze voor de interactieve laag van de architectuur gemaakt, die in de volgende hoofdstukken technisch zal worden onderbouwd.

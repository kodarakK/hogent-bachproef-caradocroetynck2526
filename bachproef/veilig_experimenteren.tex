...
\begin{itemize}
    \item \textbf{Bestandssysteem-isolatie:} De container heeft een eigen read-only root-bestandssysteem. Wijzigingen die een onderzoeker aanbrengt aan de systeemconfiguratie van de container gaan verloren na het afsluiten van de sessie, waardoor de omgeving altijd schoon blijft voor de volgende run.
